...
export const projects: Project[] = [
  ...
  },
  {
    ...
    des: "Pinterest Clone is a full-stack clone of Pinterest that allows users to create and share pins, explore and save pins, and create and manage boards for organizing and categorizing pins.",
    img: "/images/Pinterest-cover.PNG",
    iconLists: [
      "/images/logos/ts.svg",
      "/images/logos/re.svg",
      "/images/logos/node.svg",
  ...
  },
  {
    id: 9,
    title: "PrepWise",
    des: "PrepWise is an AI-powered interview practice app that lets users simulate real interviews vocally, receive personalized feedback, identify strengths, and improve communication skills. It's a valuable resource for preparing for interviews and enhancing interview skills.",
    img: "/images/PrepWise-cover.png",
    iconLists: [
      "/images/logos/next.svg",
      "/images/logos/ts.svg",
      "/images/logos/firebase.svg",
      "/images/logos/shadcn.svg",
      "/images/logos/zod.svg",
    ],
    status: "Coming soon",
  },
  {
    id: 9,
    title: "Trello Clone",
    des: "Trello Clone is a full-stack clone of Trello that allows users to create and manage boards, lists, and cards for organizing and managing tasks and projects.",
    img: "/images/Trello-cover.png",
    iconLists: [
      "/images/logos/next.svg",
      "/images/logos/ts.svg",
      "/images/logos/re.svg",
      "/images/logos/prisma.svg",
  ...
  },
  {
    id: 10,
    title: "Evently",
    des: "Evently is a full-stack event management app that allows verified organizers to create and host events, while users can explore, view event details, and purchase tickets directly through the platform.",
    img: "/images/Evently-cover.png",
    iconLists: [
      "/images/logos/next.svg",
      "/images/logos/ts.svg",
      "/images/logos/mongo.svg",
      "/images/logos/clerk.svg",
      "/images/logos/stripe.svg",
    ],
    status: "Coming soon",
  },
  {
    id: 11,
    title: "Slack Clone",
    des: "Slack Clone is a full-stack clone of Slack that allows users to create and manage channels, send messages, and connect with others in real-time.",
    img: "/images/slack-cover.jpeg",
    iconLists: [
      "/images/logos/next.svg",
      "/images/logos/ts.svg",
      "/images/logos/re.svg",
  ...
  },
  {
    id: 12,
    title: "Youtube Clone",
    des: "Youtube Clone is a full-stack clone of Youtube that allows users to create and manage channels, send messages, and connect with others in real-time.",
    img: "/images/youtube-cover.png",
    iconLists: [
      "/images/logos/next.svg",
      "/images/logos/ts.svg",
      "/images/logos/re.svg",
  ...
  },
  {
    id: 13,
    title: "CodeSync",
    des: "CodeSync is a full-stack technical interview platform that connects candidates and interviewers in real-time. Interviewers can host live video calls with an integrated code editor, share coding questions, and evaluate candidates on the spot. After the session, interviewers can leave feedback and track candidate performance through their personal dashboard.",
    img: "/images/CodeSync-cover.png",
    iconLists: [
      "/images/logos/next.svg",
      "/images/logos/ts.svg",
      "/images/logos/re.svg",
  ...
  },
  {
    id: 14,
    title: "Modimal",
    des: "Modimal is a modern e-commerce fashion platform that allows users to browse, discover, and purchase clothing and accessories, offering a smooth shopping experience with a clean, stylish interface.",
    img: "/images/modimal.png",
    iconLists: [
      "/images/logos/next.svg",
      "/images/logos/ts.svg",
      "/images/logos/re.svg",
